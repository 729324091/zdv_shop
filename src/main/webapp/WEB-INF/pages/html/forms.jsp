...
<html>
  <head>
    ...
    <!-- Bootstrap -->
    <link href="${ctx}/assets/BootstrapTheme3/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <!-- styles -->
    <link href="css/styles.css" rel="stylesheet">

    <link href="//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" rel="stylesheet">
    <link href="${ctx}/assets/BootstrapTheme3/vendors/form-helpers/css/bootstrap-formhelpers.min.css" rel="stylesheet">
    <link href="${ctx}/assets/BootstrapTheme3/vendors/select/bootstrap-select.min.css" rel="stylesheet">
    <link href="${ctx}/assets/BootstrapTheme3/vendors/tags/css/bootstrap-tags.css" rel="stylesheet">
  ...
  <body>
    ...
    <script src="${ctx}/assets/BootstrapTheme3/bootstrap/js/bootstrap.min.js"></script>

    <script src="${ctx}/assets/BootstrapTheme3/vendors/form-helpers/js/bootstrap-formhelpers.min.js"></script>

    <script src="${ctx}/assets/BootstrapTheme3/vendors/select/bootstrap-select.min.js"></script>

    <script src="${ctx}/assets/BootstrapTheme3/vendors/tags/js/bootstrap-tags.min.js"></script>

    <script src="${ctx}/assets/BootstrapTheme3/vendors/mask/jquery.maskedinput.min.js"></script>

    <script src="${ctx}/assets/BootstrapTheme3/vendors/moment/moment.min.js"></script>

    <script src="${ctx}/assets/BootstrapTheme3/vendors/wizard/jquery.bootstrap.wizard.min.js"></script>

     <!-- bootstrap-datetimepicker -->
     <link href="${ctx}/assets/BootstrapTheme3/vendors/bootstrap-datetimepicker/datetimepicker.css" rel="stylesheet">
     <script src="${ctx}/assets/BootstrapTheme3/vendors/bootstrap-datetimepicker/bootstrap-datetimepicker.js"></script> 


    <link href="//cdnjs.cloudflare.com/ajax/libs/x-editable/1.5.0/bootstrap3-editable/css/bootstrap-editable.css" rel="stylesheet"/>
	<script src="//cdnjs.cloudflare.com/ajax/libs/x-editable/1.5.0/bootstrap3-editable/js/bootstrap-editable.min.js"></script>

    <script src="${ctx}/assets/BootstrapTheme3/js/custom.js"></script>
    <script src="${ctx}/assets/BootstrapTheme3/js/forms.js"></script>
  </body>
</html>