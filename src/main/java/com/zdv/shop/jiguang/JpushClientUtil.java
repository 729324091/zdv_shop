...
public class JpushClientUtil{
    ...
    private final static String appKey = "e7cf90113db2711e10d40c11";
 
    private final static String masterSecret = "583091c62ea7670e53cb1adc";
	...
	public static void main(String[] args) {
		...
		sendToAll("notification_title","msg_title", "msg_content","1");
	}
