 ...
 * @data 2019年2月19日 
 */
@Table(name = "ot_comp_product_stock_objname")
public class OtCompProductStockObjname {
	...
	public String toString() {
		return "OtCompProductStockObjname [uobjnamevalueid=" + uobjnamevalueid + ", uproductid=" + uproductid
