...
public class WeixinPayTest {
	...
	/*	try {
		...
		//参数组
		String appid = config.gappid;
		//System.out.println("201609240015101075984152175651".length()+"appid是："+appid);
		String mch_id = config.gmch_id;
		/*String appid="wx4363b96513fd59de";
		String mch_id="1385478902";
		String appSecret ="6485bfb56fca5b09a7ef2779eca41316";*/
		//System.out.println("mch_id是："+mch_id);
		String nonce_str = RandCharsUtils.getRandomString(32);
		//System.out.println("随机字符串是："+nonce_str);
		String body = "jock测试微信支付0.01";
		...
		System.out.println(time1+"\\"+Long.toString(new Date().getTime()));
		String openid = "osFug50ruLdk0sNdBcOKahW5AALw";
		//参数：开始生成签名
		...
		//sign = "B2EB47D41CB22C80B67ECA8CA2F559AA";

		Unifiedorder unifiedorder = new Unifiedorder();
		unifiedorder.setAppid(appid);
		unifiedorder.setMch_id(mch_id);
		//unifiedorder.setSub_appid("wx7d22f0ee17502f9a");
