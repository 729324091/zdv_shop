...
public class PageAjax<T> implements Serializable {
    ...
    /**是否为第一页*/
    private boolean ifFirstPage = false;
    /**是否为最后一页*/
    private boolean ifLastPage = false;
    /**是否有前一页*/
...
//            this.orderBy = page.getOrderBy();
    ...
    private void judgePageBoudary() {
        ifFirstPage = pageNo == 1;
        ifLastPage = pageNo == pages;
    ...
    public String toString() {
        ...
        sb.append(", isFirstPage=").append(ifFirstPage);
        sb.append(", isLastPage=").append(ifLastPage);
