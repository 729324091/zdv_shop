...
public class UploadUtil {
    ...
    public String upload(MultipartFile file, String docBase, String path) {
        String filepath = "";
                if (file != null) {
                    // 重命名上传后的文件名
                    String nowName = getNewName(".jpg");
    ...
    public String getFilePath(String filepath, String filename) {
    	StringBuilder sb = new StringBuilder(filepath).append(DateUtil.getCurDate("yyyyMMdd")).append(File.separatorChar).append(filename);
        return sb.toString();
    }
